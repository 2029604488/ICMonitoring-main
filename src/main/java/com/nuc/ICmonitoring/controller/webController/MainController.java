    ...
    public ResultBody getMenu(HttpServletRequest request) {
        if ("admin".equals(jwtUtils.getIdentity(request))) {
            return ResultBody.success(JSON.parse("[\n" +
                    "        {\n" +
                    "          index: 1, name: \"芯片数据\", lists: [\n" +
                    "            {index: 1, name: \"芯片数据\", path: \"heatData\"},\n" +
                    "            {index: 2, name: \"历史记录图表\", path: \"chart\"},\n" +
                    "            {index: 3, name: \"动态数据展示\", path: \"dynamic\"},\n" +
                    "          ]\n" +
                    "        }," +
                    "     \n" +
                    "        {\n" +
                    "          index: 2, name: \"操作用户管理\", lists: [\n" +
                    "            {index: 4, name: \"用户管理\", path: \"user\"},\n" +
                    "          ]\n" +
                    "        }, " +
                    "         {\n" +
                    "          index: 3, name: \"芯片管理\", lists: [\n" +
                    "            {index: 5, name: \"芯片管理\", path: \"manage\"},\n" +
                    "          ]\n" +
                    "        }," +
                            "         {\n" +
                            ...
                            "        },"+
                    "         {\n" +
                    "          index: 5, name: \"芯片使用预测\", lists: [\n" +
                    "            {index: 7, name: \"芯片使用年限预测\", path: \"forecast\"},\n" +
                    "          ]\n" +
                    "        },"+
                    "    \n" +
                    "      ]"));
